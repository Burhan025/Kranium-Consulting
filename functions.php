...
function parallax_enqueue_scripts_styles() {
	...
	wp_enqueue_style( 'googlefonts', '//fonts.googleapis.com/css?family=Montserrat|Poppins:300,400,500,700', array() );
